--
-- Creates PostgreSQL tables and indexes for Pekko Persistence.
--
-- Based on https://github.com/apache/pekko-persistence-jdbc/blob/a6a7573e70988e96a1ce00d91ac0a341478512fb/core/src/main/resources/schema/postgres/postgres-create-schema.sql
--

CREATE TABLE IF NOT EXISTS public.event_journal(
  ordering BIGSERIAL,
  persistence_id TEXT NOT NULL, -- TEXT instead of VARCHAR because the length of URLs is unlimited.
